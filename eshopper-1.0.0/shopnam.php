...
<body>
    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
            <h1 class="font-weight-semi-bold text-uppercase mb-3">Sản phẩm nam </h1>
...
Sắp xếp theo
                    ...
                    <?php
                    $sql = "SELECT * FROM tb_sanpham Where gioitinh='nam'   ";
                        ...
                        while($rows = mysqli_fetch_assoc($rel)){
                            ...
                            <?php 
                                                  if($img =="")
                                                  {
                                                      ...
                                                      ?>
                                                       <img style="height: 300px;" class="img-fluid w-100" src="<?php echo SITE;?>IMG/<?php echo $img;?> ">
                                                      <?php
                                                  }
                                                ?>
