...
<body>
    ...
    <div class="container-fluid bg-secondary mb-5">
        ...
        <?php 
                                   $search = $_POST['search'];
                                 ?>
            <h1 class="font-weight-semi-bold text-uppercase mb-3">Tìm kiếm sản phẩm "<?php echo $search;?> "</h1>
            <div class="d-inline-flex">
                <p class="m-0"><a href="">Trang chủ</a></p>
                <p class="m-0 px-2">-</p>
                <p class="m-0"><?php echo $search;?> </p>
            </div>
        </div>
    </div>
    <!-- Page Header End -->
        ...
        <div class="row px-xl-5">
                ...
                <div class="border-bottom mb-4 pb-4">
                    ...
                    <form>
                        ...
                        <div
                            ...
                            <label class="custom-control-label" for="price-2">100000 - 200000</label>
                            <!-- <span class="badge border font-weight-normal">295</span> -->
                        </div>
                        <div
                            class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                            <input type="checkbox" class="custom-control-input" id="price-3">
                            <label class="custom-control-label" for="price-3">200000 - 300000</label>
                            <!-- <span class="badge border font-weight-normal">246</span> -->
                        </div>
                        <div
                            class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                            <input type="checkbox" class="custom-control-input" id="price-4">
                            <label class="custom-control-label" for="price-4">300000 - 400000</label>
                            <!-- <span class="badge border font-weight-normal">145</span> -->
                        </div>
                        <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between">
                            <input type="checkbox" class="custom-control-input" id="price-5">
                            <label class="custom-control-label" for="price-5">400000 - 500000</label>
                ...
                <div class="border-bottom mb-4 pb-4">
                    ...
                    <form>
                        <div
                            ...
                            <label class="custom-control-label" for="price-all">Màu sắc</label>
                            <!-- <span class="badge border font-weight-normal">1000</span> -->
                        </div>
                        <div
                            class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                        ...
                        <div
                            ...
                            <label class="custom-control-label" for="color-4">Xanh lam</label>
                            <!-- <span class="badge border font-weight-normal">145</span> -->
                        </div>
                        <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between">
            ...
            <div class="col-lg-9 col-md-12">
                <div class="row pb-3">
                    ...
                    <?php
                    $search = $_POST['search'];
                    $sql = "SELECT * FROM tb_sanpham WHERE ten_sp LIKE '%$search%'";
                    ...
                    <div class="col-md-4 mb-5">
                        ...
                        <form action="">
                            <div class="form-group">
                                <input type="text" class="form-control border-0 py-4" placeholder="Họ tên khách hàng"
                                    required="required" />
                            </div>
                            <div class="form-group">
                            ...
                            <div>
                                <button class="btn btn-primary btn-block border-0 py-3" type="submit">Theo dõi
                                    ngay</button>
                            </div>
                        </form>
                    </div>
