...
<body>
        ...
        <div class="row px-xl-5">
                ...
                <div class="contact-form">
                    ...
                    <form name="sentMessage" id="contactForm" novalidate="novalidate" method="POST">
                        <div class="control-group">
                            <input type="text" class="form-control" id="name" name="ten_kh" placeholder="Tên của bạn"
                        ...
                        <div class="control-group">
                            <input type="text" class="form-control" id="subject" name="chude" placeholder="Chủ đề"
                                required="required" data-validation-required-message=" Xin hãy nhập chủ đề" />
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class="control-group">
                            <textarea class="form-control" rows="6" id="message" name="noidung" placeholder="Nội dung"
                                required="required"
                                data-validation-required-message="Xin hãy nhập nội dung"></textarea>
                            <p class="help-block text-danger"></p>
                        </div>
                        <div>
                            <button class="btn btn-primary py-2 px-4" name="submit" type="submit" id="sendMessageButton">Phản hồi</button>
                        </div>
                    </form>
                </div>
            </div>
            <div class="col-lg-5 mb-5">
                ...
                <div class="d-flex flex-column mb-3">
                    ...
                    <p class="mb-2"><i class="fa fa-map-marker-alt text-primary mr-3"></i>Đan Phượng, Hà Tây</p>
                    <p class="mb-2"><i class="fa fa-envelope text-primary mr-3"></i>dinhdoan9908@gmail.com</p>
                    <p class="mb-2"><i class="fa fa-phone-alt text-primary mr-3"></i>+084 987654321</p>
                </div>
    ...
    <!-- Footer Start -->  <div class="container-fluid bg-secondary text-dark mt-5 pt-5">
...
if(isset($_POST['submit'])){
	...
	$sql4 = "INSERT INTO tb_lienhe SET
	ten_kh = '$ten_kh',
	email = '$email',
	chude = '$chude',
	noidung = '$noidung'
