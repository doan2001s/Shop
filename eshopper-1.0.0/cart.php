                         ...
                         <tr>
                            ...
                            <?php 
                                                  if($img =="")
                                                  {
                                                      ...
                                                      ?>
                                                       <img style="width: 50px;" src="<?php echo SITE;?>IMG/<?php echo $img;?>">
                                                      <?php
                                                  }
                                                ?>
                                
                            </td>
                            <td class="align-middle"><?php echo number_format(floatval($row['giasale']), 0, ".", ",");?></td>
                            <td class="align-middle">
                                <div class="input-group quantity mx-auto" style="width: 100px;">
                                    ...
                                    <input type="text" class="form-control form-control-sm bg-secondary text-center "  name="txtProductQuantity" 
                            ...
                            <td class="align-middle"><?php echo number_format(floatval($price), 0, ".", ",");?></td>
                            <td class="align-middle">
                                <a href="cart.php?delete=<?php echo $row['ma_sp']; ?>">
                                <button class="btn btn-sm btn-primary"><i class="fa fa-times"></i>
                                </button>
                                </a>
                            </td>
                        </tr>                   
                ...
                <div class="card border-secondary mb-5">
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between mb-3 pt-1">
                            ...
                            <h6 class="font-weight-medium"><?php echo number_format(floatval($total), 0, ".", ","); ?></h6>
                        </div>
                    ...
                    <div class="card-footer border-secondary bg-transparent">
                        <div class="d-flex justify-content-between mt-2">
                            ...
                            <h5 class="font-weight-bold"><?php echo number_format(floatval($total), 0, ".", ","); ?></h5>
                        </div>
                        <a href="checkout.php">
