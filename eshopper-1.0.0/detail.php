...
<body>
    ...
    <!-- Navbar Start -->
    <?php include('../connect/navbar.php')?>
    <!-- Navbar End -->
    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
            ...
            <div class="d-inline-flex">
                ...
                <p class="m-0 px-2">-</p>
                <p class="m-0">Chi tiết cửa hàng</p>
            </div>
        </div>
    </div>
    <!-- Page Header End -->
    ...
    <?php 
        ...
        <div class="row px-xl-5">
                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    ...
                    <?php 
                                                  if($img =="")
                                                  {
                                                      ...
                                                      ?>
                                                       <img class="w-100 h-100" src="<?php echo SITE;?>IMG/<?php echo $img;?>">
                                                      <?php
                                                  }
                                                ?>
                    </div>
            ...
            <div class="col-lg-7 pb-5">
                ...
                <h3 class="font-weight-semi-bold"><?php echo $ten_sp?></h3>
                ...
                <h3 class="font-weight-semi-bold mb-4"><?php echo $giasale;?>VND</h3>
                ...
                <form method="post" action="cart.php?ID=<?php echo $rows['ma_sp']; ?>">
                <div class="d-flex align-items-center mb-4 pt-2">
                    <div class="input-group quantity mr-3" style="width: 130px;">
                        ...
                        <input type="text" class="form-control bg-secondary text-center" name="txtProductQuantity" value="1">
                        <div class="input-group-btn">
                    ...
                    <a href="">
                    <button  type="submit" onclick=" checkButton()" class="btn btn-primary px-3"><i class="fa fa-shopping-cart mr-1"></i>Thêm vào giỏ hàng</button>
                    </a>
                    </form>
                </div>
            ...
            <div class="col">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade" id="tab-pane-3">
                        <div class="row">
                            <div class="col-md-6">
                                <h4 class="mb-4"> Đánh giá sản phẩm "<?php echo $ten_sp;?>"</h4>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="d-flex my-3">
                                    <p class="mb-0 mr-2">Xếp hạng của bạn * :</p>
    ...
    <div class="container-fluid py-5">
        ...
        <div class="row px-xl-5">
            <div class="col">
                ...
                <?php
               $sql = "SELECT * FROM tb_sanpham LIMIT 8 ";
                    ...
                    <div class="card product-item border-0">
                        ...
                        <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                            ...
                            <div class="d-flex justify-content-center">
                                <h6><?php echo $giasale;?></h6><h6 class="text-muted ml-2"><del><?php echo $giaban;?></del></h6>
                            </div>
                        </div>
                        <div class="card-footer d-flex justify-content-between bg-light border">
                            ...
                            <!-- <a href="?request=cart&action=add&ma_sp=<?=$ma_sp;?>" class="btn btn-sm text-dark p-0"><i class="fas fa-shopping-cart text-primary mr-1"></i>Thêm giỏ hàng</a> -->
                        </div>
                    </div>
                    <?php
                }
...
function checkButton() {    
            if(document.getElementById('size-1').checked) {   
                document.getElementById("disp").innerHTML   
                    = document.getElementById("siz2-1").value   
                    + " radio button is checked";   
            }   
            else if(document.getElementById('size-2').checked) {   
                document.getElementById("disp").innerHTML   
                    = document.getElementById("size-2").value   
                    + " radio button is checked";     
            }   
            else if(document.getElementById('size-3').checked) {   
                document.getElementById("disp").innerHTML   
                    = document.getElementById("size-3").value   
                    + " radio button is checked";     
            }   
            else if(document.getElementById('size-4').checked) {   
                document.getElementById("disp").innerHTML   
                    = document.getElementById("size-4").value   
                    + " radio button is checked";     
            }  
            else if(document.getElementById('size-5').checked) {   
                document.getElementById("disp").innerHTML   
                    = document.getElementById("size-5").value   
                    + " radio button is checked";     
            }  
            else {   
