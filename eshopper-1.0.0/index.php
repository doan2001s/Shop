...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row align-items-center py-3 px-xl-5">
            ...
            <div class="col-lg-6 col-6 text-left">
                <form  method="POST" action="<?php echo SITEURL;?>search.php">
            ...
            <div class="col-lg-3 col-6 text-right">
                ...
                <a href="?request=cart" class="btn border">
                    ...
                    <div class="navbar-nav w-100 overflow-hidden" style="height: 287px">
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu position-absolute bg-secondary border-0 rounded-0 w-100 m-0">
                                <a href="shopnam.php" class="dropdown-item">Quần áo Nam</a>
                                <a href="shopnu.php" class="dropdown-item">Quần áo Nữ</a>
                                <a href="shoptre.php" class="dropdown-item">Quần áo Trẻ em</a>
                            </div>
                        </div>
                        <a href="shopaosomi.php" class="nav-item nav-link">Áo sơ mi</a>
                        <a href="shopquanbo.php" class="nav-item nav-link">Quần bò</a>
                        <a href="shopvay.php" class="nav-item nav-link">Váy</a>
                        <a href="shopkinh.php" class="nav-item nav-link">Kính</a>
                        <a href="shoptuisach.php" class="nav-item nav-link">Túi sách</a>
                        <a href="shopgiay.php" class="nav-item nav-link">Giày</a>
                    </div>
                </nav>
            </div>
            <div class="col-lg-9">
                        ...
                        <div class="carousel-item active" style="height: 410px;">
                            ...
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                                    ...
                                    <h3 class="display-4 text-white font-weight-semi-bold mb-4">Quần áo thời trang</h3>
        ...
        <div class="row px-xl-5 pb-3">
            ...
            <div class="col-lg-4 col-md-6 pb-1">
                <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                    <p class="text-right"></p>
                    <a href="" class="cat-img position-relative overflow-hidden mb-3">
                        <img style="width: 305px; height: 260px;" class="img-fluid" src="img/cff1842ed851230f7a40.jpg" alt="">
                    </a>
            ...
            <div class="col-lg-4 col-md-6 pb-1">
                <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                    ...
                    <h5 class="font-weight-semi-bold m-0">Túi sách</h5>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 pb-1">
                <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
            ...
            <div class="col-md-6 pb-4">
                <div class="position-relative bg-secondary text-center text-md-right text-white mb-2 py-5 px-5">
                    ...
                    <div class="position-relative" style="z-index: 1;">
                        <h5 class="text-uppercase text-primary mb-3">Giảm 20% cho tất cả các đơn đặt hàng</h5>
    ...
    <div class="container-fluid pt-5">
        ...
        <div class="row px-xl-5 pb-3">
            <?php
               $sql = "SELECT * FROM tb_sanpham LIMIT 4 ";
                ...
                <div class="card product-item border-0 mb-4">
                    ...
                    <?php 
                                                  if($img =="")
                                                  {
                                                      ...
                                                      ?>
                                                       <img class="img-fluid w-100" src="<?php echo SITE;?>IMG/<?php echo $img;?>">
                                                      <?php
                                                  }
                                                ?>
                    ...
                    <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                        <h6 class="text-truncate mb-3"><?php echo $ten_sp;?></h6>
                        <div class="d-flex justify-content-center">
                            <h6><?php echo number_format(floatval($giasale), 0, ".", ",");?>VND</h6><h6 class="text-muted ml-2"><del><?php echo number_format(floatval($giaban), 0, ".", ",");?>VND</del></h6>
                        </div>
                    </div>
                    <div class="card-footer d-flex justify-content-between bg-light border">
                        <a href="<?php SITE;?>detail.php?ma_sp=<?php echo $ma_sp;?>" class="btn btn-sm text-dark p-0"><i class="fas fa-eye text-primary mr-1"></i>Xem sản phẩm</a>
                        <!-- <a href="?request=cart&action=add&ma_sp=<?=$ma_sp?>" class="btn btn-sm text-dark p-0"><i class="fas fa-shopping-cart text-primary mr-1"></i>Thêm vào giỏ hàng</a> -->
                    </div>
                </div>
            </div>
        ...
        <div class="row justify-content-md-center py-5 px-xl-5">
            <div class="col-md-6 col-12 py-5">
                <div class="text-center mb-2 pb-2">
                    <h2 class="section-title px-5 mb-3"><span class="bg-secondary px-2">Sản phẩm mới</span></h2>
                    <p>Bộ sưu tập mới nhất được đón chờ trong năm nay.</p>
                </div>
                <form action="">
                    <div class="input-group">
