...
<li class="submenu">
<a href="#"><i class="la la-rocket"></i> <span> Sản phẩm</span> <span class="menu-arrow"></span></a>
<ul style="display: none;">
...
<li><a href="tickets.php">Hóa đơn</a></li>
        ...
        <div class="page-wrapper">
            ...
            <div class="content container-fluid">
                ...
                <div class="page-header">
                    <div class="row">
                        <div class="col-sm-12">
                            <h3 class="page-title">Tiểu sử</h3>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="index.html">Trang chủ</a></li>
                                <li class="breadcrumb-item active">Tiểu sử</li>
                            </ul>
                        </div>
                    </div>
                </div>
	  ...
	  if(isset($_GET['ma_nv'])){
		  $ma_nv = $_GET['ma_nv'];
		  $sql = "SELECT * FROM tb_admin WHERE ma_nv = '$ma_nv' ";
                                ...
                                <div class="profile-view">
                                    <div class="profile-img-wrap">
                                        <div class="profile-img">
                                            <a href="">
                                                <!-- <img src="../IMG/meomeo.jpeg" alt="" style="width: 120px;" height="90px;" > -->
                                            </a>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-5">
                                                <div class="profile-info-left">
                                                    <h3 class="user-name m-t-0"><?php echo $ten_nv;?></h3>
                                                    <small class="text-muted">Admin</small>
                                                    <div class="staff-id">Mã nhân viên : <?php echo $ma_nv?></div>
                                                </div>
                                            </div>
                                            <div class="col-md-7">
                                                <ul class="personal-info">
                                                    ...
                                                    <li>
                                                        ...
                                                        <span class="text"><a href=""><span class="__cf_email__"
                                                                    data-cfemail="ee8c8f9c9c978d9b8a8fae8b968f839e828bc08d8183">[<?php echo $email;?>]</span></a></span>
                                                    </li>
                                                    <li>
                                                        <span class="title">Địa chỉ:</span>
                                                        <span class="text"><?php echo $diachi;?></span>
                                                    </li>
                                                    <li>
